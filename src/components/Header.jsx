        ...
        <motion.img
...

          {
            isMenu && (
              ...
              {user && user.email=== "njugunafrancis077@gmail.com" && (
                <Link to={"/createItem"}>
      ...
      <div className='flex items-center justify-between md:hidden w-full h-full'>
        ...
        <ul
         className='flex flex-col'>
          <li className='text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor- hover:bg-slate-100 px-4 py-2' onClick={() =>setIsMenu(false)}>Home</li>
          <li className='text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor- hover:bg-slate-100 px-4 py-2' onClick={() =>setIsMenu(false)}>Menu</li>
          <li className='text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor- hover:bg-slate-100 px-4 py-2' onClick={() =>setIsMenu(false)}>About us</li>
          <li className='text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor- hover:bg-slate-100 px-4 py-2' onClick={() =>setIsMenu(false)}>Services</li>
        </ul>
        
              <p className='m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-red-200 gap-3 cursor-pointer hover:bg-slate-300 transition-all duration-100 ease-in-out text-textColor text-base'
              onClick={logout}
              >Logout <MdLogout /></p>
            </motion.div>
            )
