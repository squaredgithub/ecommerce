...
function HomeContainer() {
  return (
    ...
    <div className='py-2 flex-1 flex flex-col items-start justify-center gap-6'>
       ...
       <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsam corrupti ipsum officia eaque molestiae nam vel quis voluptates nihil maxime dignissimos, aut tenetur repellat culpa. Ullam laboriosam architecto eligendi ad.</p>
     <button type='button' className='bg-gradient-to-br from-orange-400 to-orange-500 w-full md:w-auto px-4 py-2'>Order Now</button>
    </div>
    <div className='py-2 flex-1 flex items-center relative'>
        ...
        <div className='w-full h-full absolute top-0 left-0 flex items-center justify-center py-4 gap-4 flex-wrap'>
           {heroData && heroData.map((n) => (
             ...
             <img src={n.imageSrc} className="w-20 lg:w-40 lg:-mt-20 -mt-10" alt="I1" />
